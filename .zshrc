...
# zsh-autocomplete fast-syntax-highlighting 
...
if [ -e "usr/sbin/sudo" ]; then
    alias sudo='sudo '
fi

if [ -e "/usr/sbin/nvim" ]; then
    alias vim='nvim'
fi

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/waleed/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
unset __conda_setup
# <<< conda initialize <<<
# >> Exporting variables to be used
